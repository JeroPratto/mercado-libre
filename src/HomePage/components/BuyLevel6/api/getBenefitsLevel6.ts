...
const getBenefitsLevel6Mock = (): BenefitsBuyLevelInterface => {
	const benefits = {
		...
		benefits: [
			{
				src: 'src/HomePage/components/BuyLevel6/images/dplus-icon.svg',
				alt: '#',
				description: 'Disney+ sin cargo',
			},
			{
				src: 'src/HomePage/components/BuyLevel6/images/starplus-icon.svg',
				alt: '#',
				description: 'Star+ sin cargo',
			},
			{
				src: 'src/HomePage/components/BuyLevel6/images/truck-icon.png',
				alt: '#',
				description:
