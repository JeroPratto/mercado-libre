const getBenefitsMPMock = () => {
	const benefitsMPMock = [
		{
			urlImgBackground: './images/multicontent.jpg',
			alt: 'Disney+ y Star+',
			urlIcon: './images/comboplus-square-multicontent.jpg',
			description:
		...
		{
			urlImgBackground: './images/HBOMAX.jpg',
			alt: 'hbo max',
			urlIcon: './images/hbomax-icon.png',
		...
		{
			urlImgBackground: './images/paramount.jpg',
			alt: 'paramount+',
			urlIcon: './images/paramount-icon.png',
			description:
