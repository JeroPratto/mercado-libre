const getBenefitsMPMock = () => {
	const benefitsMPMock = [
		{
			urlImgBackground:
				'/src/HomePage/components/BenefitsMP/images/multicontent.jpg',
			alt: 'Disney+ y Star+',
			urlIcon:
				'/src/HomePage/components/BenefitsMP/images/comboplus-square-multicontent.jpg',
			description:
		...
		{
			urlImgBackground: '/src/HomePage/components/BenefitsMP/images/HBOMAX.jpg',
			alt: 'hbo max',
			urlIcon: '/src/HomePage/components/BenefitsMP/images/hbomax-icon.png',
		...
		{
			urlImgBackground:
				'/src/HomePage/components/BenefitsMP/images/paramount.jpg',
			alt: 'paramount+',
			urlIcon: '/src/HomePage/components/BenefitsMP/images/paramount-icon.png',
			description:
