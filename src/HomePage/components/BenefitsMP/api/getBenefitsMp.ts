const getBenefitsMPMock = () => {
	const benefitsMPMock = [
		{
			urlImgBackground:
				'HomePage/components/BenefitsMP/images/multicontent.jpg',
			alt: 'Disney+ y Star+',
			urlIcon:
				'HomePage/components/BenefitsMP/images/comboplus-square-multicontent.jpg',
			description:
		...
		{
			urlImgBackground: 'HomePage/components/BenefitsMP/images/HBOMAX.jpg',
			alt: 'hbo max',
			urlIcon: 'HomePage/components/BenefitsMP/images/hbomax-icon.png',
		...
		{
			urlImgBackground: 'HomePage/components/BenefitsMP/images/paramount.jpg',
			alt: 'paramount+',
			urlIcon: 'HomePage/components/BenefitsMP/images/paramount-icon.png',
			description:
